	...
	return (
		<div className="dark min-h-screen bg-[hsl(var(--background))]">
			...
			<section className="mx-auto flex max-w-[980px] flex-col items-start gap-2 py-8 md:py-12 md:pb-8 lg:py-40 lg:pb-20 dotted-paper-background">
				<h1 className="text-left text-3xl font-bold leading-tight tracking-tighter md:text-5xl lg:leading-[1.1] text-[hsl(var(--foreground))] ml-4">
					Hi I'm Nicholas!
				</h1>

				<p className="text-left text-[16.8px] font-light text-[hsl(var(--foreground))] mt-4 md:mt-6 lg:mt-8 ml-4">
					<Balancer>
				...
				<nav className="flex items-center gap-4 py-4 mt-8 md:mt-10 lg:mt-12 ml-4">
					<Link
